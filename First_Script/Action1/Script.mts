...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("HP S9500 BLUETOOTH WIRELESS").Check CheckPoint("HP S9500 BLUETOOTH WIRELESS SPEAKER") @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("HP S9500 BLUETOOTH WIRELESS")_;_script infofile_;_ZIP::ssf3.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebButton("check_out_btn").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebButton("check out btn")_;_script infofile_;_ZIP::ssf5.xml_;_
